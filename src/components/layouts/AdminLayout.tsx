...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const adminNavigation = [
    ...
    { name: 'Advertisements', href: '/admin/advertisements', icon: <Star size={20} /> },
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      {/* Sidebar Navigation */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 flex flex-col bg-sidebar glass shadow-lg shadow-primary/5 fixed h-full transition-all duration-300 ease-in-out z-50 md:z-30`}>
