...
const ChatRoom = ({
  ...
  return <div className="h-[80vh] md:h-[700px] flex flex-col bg-gradient-to-br from-background/95 via-background/90 to-background/95 backdrop-blur-xl border border-border/20 rounded-2xl shadow-2xl overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 md:p-6 bg-gradient-to-r from-primary/5 via-transparent to-accent/5 border-b border-border/10">
        ...
        {selectedRoom && <Button size="sm" variant="outline" onClick={() => setSelectedRoom(null)} className="rounded-full bg-background/50 backdrop-blur border-border/20 hover:bg-background/80">
            Back to Global
          </Button>}
      </div>
