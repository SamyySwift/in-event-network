  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-3 sm:p-6">
      <div className="overflow-hidden animate-fade-in">
        <div className="pb-4 px-4 sm:px-6 border-b border-border/20">
        ...
        <div className="h-[75vh] overflow-y-auto scroll-smooth p-0">
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="flex flex-col items-center space-y-6 py-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative bg-background/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-border/50">
                  <canvas 
                    ref={canvasRef}
            ...
            {/* Usage Instructions */}
            <div className="bg-blue-50/50 dark:bg-blue-900/20 rounded-xl p-4 sm:p-6 border border-blue-200/30 dark:border-blue-700/20 space-y-4 animate-fade-in backdrop-blur-sm" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-start gap-3 p-3 bg-blue-50/30 dark:bg-blue-800/10 rounded-lg border border-blue-200/20">
            ...
            <div className="text-center space-y-3 animate-fade-in" style={{ animationDelay: '0.5s' }}>
              <div className="bg-muted/20 rounded-lg p-4 border border-border/20 backdrop-blur-sm">
              ...
              <div className="bg-accent/10 rounded-lg p-3 border border-border/10">
