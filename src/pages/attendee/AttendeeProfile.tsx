      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card>
                ...
                {isEditing ? (
                  ...
                  <div>
                    ...
                    {profileData.niche && (
                      <Badge
                        variant="secondary"
                        className="mt-1 bg-connect-100 text-connect-800 hover:bg-connect-200 dark:bg-connect-900/50 dark:text-connect-300"
                      >
                        {profileData.niche}
                      </Badge>
                    )}
          ...
          <CardContent className="pt-6 space-y-8">
              ...
              {isEditing ? (
                ...
                <div>
                  {selectedNiche ? (
                    <Badge
                      variant="outline"
                      className="bg-connect-50 border-connect-200 text-connect-800 dark:bg-connect-900/50 dark:border-connect-400 dark:text-connect-300"
                    >
                      {selectedNiche}
                    </Badge>
                  ) : (
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex">
                      <Input
                        ...
                        onChange={(e) =>
                          setCustomNetworkingPref(e.target.value)
                        }
                        className="rounded-r-none"
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Add tags that represent your interests
              </p>
                  ...
                  {profileData.customTags.length > 0 ? (
                    profileData.customTags.map((tag) => (
                      <Badge
                        key={tag}
                        variant="secondary"
                        className="bg-connect-50 text-connect-700 dark:bg-connect-900/50 dark:text-connect-300"
                      >
                        {tag}
                      </Badge>
                    ))
              ...
              {isEditing ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      <XIcon size={16} className="mr-2" />X (Twitter)
                    </Label>
                    <Input
                      id="twitter"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                  ...
                  {profileData.links.github && (
                    ...
                    >
                      <Github
                        size={24}
                        className="text-[#333] dark:text-white mb-2"
                      />
                      <span className="text-xs text-gray-900 dark:text-white">
                        GitHub
                      </span>
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Manage your account settings and data. These actions cannot be
              undone.
            </CardDescription>
          </CardHeader>
          <CardContent>
